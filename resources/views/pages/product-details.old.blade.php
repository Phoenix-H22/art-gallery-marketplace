...
<body>
    ...
    <header>
        <div class="header-container">
            <a href="/" class="logo">
                <div style="width: 40px; height: 40px; background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white;">🎨</div>
                <span>ARTGALLERY</span>
            </a>

            <div class="search-bar">
                <input type="text" placeholder="Search for paintings">
            </div>

            <div style="display: flex; gap: 20px;">
                <button style="width: 40px; height: 40px; border-radius: 50%; background: #f5f5f5; border: none; cursor: pointer;">🌍</button>
                <button style="width: 40px; height: 40px; border-radius: 50%; background: #f5f5f5; border: none; cursor: pointer;">👤</button>
                <button style="width: 40px; height: 40px; border-radius: 50%; background: #f5f5f5; border: none; cursor: pointer;">🛒</button>
            </div>
        </div>
    ...
    <div class="product-detail-container">
        ...
        <div class="gallery-section">
            <div class="main-image-container">
                <img src="https://images.unsplash.com/photo-1549887534-1541e9326642?w=800" alt="Fruitful Day Painting" class="main-image" id="mainImage">
                <div class="zoom-indicator">🔍 Click to zoom</div>
            </div>
            <div class="thumbnail-container">
                <div class="thumbnail active" onclick="changeImage(0)">
                    <img src="https://images.unsplash.com/photo-1549887534-1541e9326642?w=150" alt="Thumbnail 1">
                </div>
                <div class="thumbnail" onclick="changeImage(1)">
                    <img src="https://images.unsplash.com/photo-1578662996442-48f60103fc9e?w=150" alt="Thumbnail 2">
                </div>
                <div class="thumbnail" onclick="changeImage(2)">
                    <img src="https://images.unsplash.com/photo-1561214115-f2f134cc4912?w=150" alt="Thumbnail 3">
                </div>
            </div>
        </div>
    ...
    <div style="max-width: 1400px; margin: 0 auto; padding: 0 30px;">
        <div class="artist-section">
            ...
            <div style="text-align: center; padding-top: 20px; border-top: 1px solid #f0f0f0;">
                <p style="font-size: 13px; color: #666; margin-bottom: 10px;">Need more information? <a href="#" style="color: #667eea; text-decoration: none;">Contact Us</a></p>
            </div>
        </div>
        ...
        <div class="artist-section">
            <div class="artist-header">
                <div class="artist-avatar">
                    <img src="https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?w=150&h=150&fit=crop" alt="Magdalena Krzak">
                </div>
            ...
            <div class="artist-bio">
                MAGDALENA KRZAK was born in Tarnów, Poland. After graduating from Art School in Tarnów she continued her education at the University in Rzeszow. Her paintings present a unique combination of an abstract, figurative forms and drawing. She focuses mainly on human spirit, emotions, gestures and meanings. Her works are held internationally, as she has been exhibiting and present observations. Images of women are subtle and feminine. Her subjects are often nude and vulnerable. Created only with an outline... fluid with colors and textures they blend with the background, yet they speak to us with incredible power. The combination of figurative and abstract worlds, drawing an focus, shows delicate and feminine form of womanhood. We all see through a different veil when viewing Magdalena Krzak lives and works in Chicago, Illinois.
            </div>
            <div class="artist-stats">
                <div class="stat-item">
                    <span class="stat-icon">🎨</span>
                    <span>Featured in Saatchi Art's curated series, <a href="#" style="color: #667eea;">Rise To Watch</a></span>
                </div>
                <div class="stat-item">
                    <span class="stat-icon">🏆</span>
                    <span>Handpicked for Saatchi Art's Chief Curator for our most prestigious feature, <a href="#" style="color: #667eea;">Rising Stars</a></span>
                </div>
            </div>
        ...
        <div class="related-section">
            <div class="section-header">
                ...
                <a href="/artists/magdalena-krzak" class="view-all-link">View All →</a>
            </div>
            <div class="artworks-grid">
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1549887534-1541e9326642?w=400&h=400&fit=crop" alt="Swimmer" class="artwork-image">
                ...
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1578662996442-48f60103fc9e?w=400&h=400&fit=crop" alt="By The Pool" class="artwork-image">
                    <div class="artwork-info">
                ...
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1561214115-f2f134cc4912?w=400&h=400&fit=crop" alt="Garden Girl" class="artwork-image">
                    <div class="artwork-info">
                ...
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1578321272176-b7bbc0679853?w=400&h=400&fit=crop" alt="Queen of the Night" class="artwork-image">
                    <div class="artwork-info">
        ...
        <div class="related-section">
            <div class="section-header">
                ...
                <a href="/browse/similar" class="view-all-link">View All →</a>
            </div>
            <div class="artworks-grid">
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=400&h=400&fit=crop" alt="The Girls on the Beach" class="artwork-image">
                    <div class="artwork-info">
                ...
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1578321272176-b7bbc0679853?w=400&h=400&fit=crop" alt="Form" class="artwork-image">
                    <div class="artwork-info">
                ...
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1549887534-1541e9326642?w=400&h=400&fit=crop" alt="Depression" class="artwork-image">
                    <div class="artwork-info">
                ...
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1561214115-f2f134cc4912?w=400&h=400&fit=crop" alt="Fallen Angels" class="artwork-image">
                    <div class="artwork-info">
        ...
        <div class="related-section">
            <div class="section-header">
                ...
                <a href="/browse/paintings" class="view-all-link">View All →</a>
            </div>
            <div class="artworks-grid">
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1578662996442-48f60103fc9e?w=400&h=400&fit=crop" alt="Paper Boats" class="artwork-image">
                    <div class="artwork-info">
                ...
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=400&h=400&fit=crop" alt="The Void" class="artwork-image">
                    <div class="artwork-info">
                ...
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1549887534-1541e9326642?w=400&h=400&fit=crop" alt="Horse Painting" class="artwork-image">
                    <div class="artwork-info">
                ...
                <div class="artwork-card">
                    <img src="https://images.unsplash.com/photo-1578321272176-b7bbc0679853?w=400&h=400&fit=crop" alt="Abstract Trees" class="artwork-image">
                    <div class="artwork-info">
    ...
    <div class="footer-section">
        ...
        <div style="text-align: center; padding: 40px; background: #f8f9fa; margin: 40px 0;">
            <img src="https://images.unsplash.com/photo-1551434678-e076c223a692?w=100&h=100&fit=crop" alt="Art Advisor" style="width: 100px; height: 100px; border-radius: 50%; margin-bottom: 20px;">
            ...
            <p style="max-width: 600px; margin: 0 auto 20px; color: #666; line-height: 1.6;">
                Get free art advisory advice when you shop at Saatchi Art. Our knowledgeable curators are will guide you through a seamless, stress-free shopping experience.
            </p>
            <button style="padding: 12px 30px; background: #667eea; color: white; border: none; border-radius: 25px; cursor: pointer; font-size: 14px;">Contact Art Advisory</button>
